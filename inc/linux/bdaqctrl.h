...
/* Interface InstantAiCtrl */
   ...
   public:
      // method
      virtual ErrorCode BDAQCALL ReadAny(int32 mdlNumber, int32 chStart, int32 chCount, void *dataRaw, double *dataScaled) = 0;
   
      // property
      virtual CjcSetting* BDAQCALL getCjc() = 0;
   
      // helpers
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 ch, double &dataScaled)
      {
         return ReadAny(mdlNumber, ch, 1, NULL, &dataScaled);
      }
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 ch, int16 &dataRaw)
      {
         return ReadAny(mdlNumber, ch, 1, &dataRaw, NULL);
      }
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 ch, int32 &dataRaw)
      {
         return ReadAny(mdlNumber, ch, 1, &dataRaw, NULL);
      }
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 chStart, int32 chCount, double dataScaled[])
      {
         return ReadAny(mdlNumber, chStart, chCount, NULL, dataScaled);
      }
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 chStart, int32 chCount, int16 dataRaw[], double dataScaled[])
      {
         return ReadAny(mdlNumber, chStart, chCount, dataRaw, dataScaled);
      }
      ErrorCode BDAQCALL Read(int32 mdlNumber, int32 chStart, int32 chCount, int32 dataRaw[], double dataScaled[])
      {
         return ReadAny(mdlNumber, chStart, chCount, dataRaw, dataScaled);
      }
   };
...
class InstantAoCtrl : public AoCtrlBase
   ...
   public:
      // method
      virtual ErrorCode BDAQCALL WriteAny(int32 mdlNumber, int32 chStart, int32 chCount, void *dataRaw, double *dataScaled) = 0;

      // helpers
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 ch, double dataScaled)
      {
         return WriteAny(mdlNumber, ch, 1, NULL, &dataScaled);
      }
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 ch, int16 dataRaw)
      {
         return WriteAny(mdlNumber, ch, 1, &dataRaw, NULL);
      }
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 ch, int32 dataRaw)
      {
         return WriteAny(mdlNumber, ch, 1, &dataRaw, NULL);
      }
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 chStart, int32 chCount, double dataScaled[])
      {
         return WriteAny(mdlNumber, chStart, chCount, NULL, dataScaled);
      }
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 chStart, int32 chCount, int16 dataRaw[])
      {
         return WriteAny(mdlNumber, chStart, chCount, dataRaw, NULL);
      }
      ErrorCode BDAQCALL Write(int32 mdlNumber, int32 chStart, int32 chCount, int32 dataRaw[])
      {
         return WriteAny(mdlNumber, chStart, chCount, dataRaw, NULL);
      }
   };
...
public:
   ...
   virtual ICollection<int32>*              BDAQCALL getInitailValues() = 0;
   virtual ICollection<int32>*              BDAQCALL getSnapEventSources() = 0;
};
